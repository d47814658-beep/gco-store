...
import { Monitor, ArrowLeft, Loader2, ShoppingCart } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl border border-primary text-primary font-semibold text-sm hover:bg-primary/50 transition-colors flex items-center justify-center gap-2 mt-2"
            >
